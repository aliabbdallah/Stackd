# Step-by-Step MVC Migration Checklist

- [x] 1. Separate Models, Views, and Controllers (Login feature: done)
  - [x] Create UserModel.cs
  - [x] Refactor LoginUI.cs into LoginView.cs (UI only)
  - [x] Create LoginController.cs (logic)
- [ ] 1b. Separate Models, Views, and Controllers (Sign Up feature: in progress)
  - [ ] Refactor SignUpUI.cs into SignUpView.cs (UI only)
  - [ ] Create SignUpController.cs (logic)
  - [ ] Update APIManager usage for SignUpController
- [ ] 2. Decouple UI from Logic
- [ ] 3. Use Events/Observer Pattern
- [ ] 4. Refactor Example: Login (LoginView, LoginController, UserModel)
- [ ] 5. Avoid Direct References (use interfaces/events/DI)
